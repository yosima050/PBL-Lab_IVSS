...
<head>
    ...
    <link rel="stylesheet" href="profilLab.css">
</head>
<body>
    <div class="container">
        <!-- Header -->
        ...
        <div class="main-content">
            ...
            <div class="image-section">
                <img src="lab-image.jpg" alt="Laboratorium" class="lab-image">
            </div>
        ...
        <br>
        <div class="vision-mission-title">Visi</div>
        <div class="section-container vission-section">
        ...
        <!-- Mission Section -->
        <div class="vision-mission-title">Misi</div>
        <div class="section-container mission-section">
